...
class PubChem(BaseModel):
    ...
    inchi: str = Field(default="", title="InChI")
    inchikey: str = Field(default="", title="InChI Key")  
    iupac: PubChemIupac = Field(default="", title="IUPAC")
    molecular_formula: str = Field(default="", title="Molecular Formula")
    smiles: PubChemSmiles = Field(default="", title="SMILES")
...
class SmallMolecule(BaseModel):
    ...
    chembl: Chembl = Field(default="", title="ChEMBL")
    drugbank: DrugBank = Field(default="", Title="DrugBank")
    drugcentral: DrugCentral = Field(default="", title="DrugCentral")
    pharmgkb: PharmGKB = Field(default="", title="PharmGKB")
    pubchem: PubChem = Field(default="", title="PubChem")
