...
class primaryCell(BaseModel):
    ...
    primaryCellDonorInformation: donorInformation | None = Field(title="Donor Information", description="Information about the human or non-human donor from which the sample material was taken. Select option 2 if none available.")
...
class tumorSample(BaseModel):
    ...
    tumorSampleDonorInformation: donorInformation | None = Field(title="Donor Information", description="Information about the human or non-human donor from which the sample material was taken. Select option 2 if none available.")
...
class tissue(BaseModel):
    ...
    tissueDonorInformation: donorInformation | None = Field(title="Donor Information", description="Information about the human or non-human donor from which the sample material was taken. Select option 2 if none available.")
