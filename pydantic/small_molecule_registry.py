...
class SmallMolecule(CustomBaseModel):
    ...
    model_config = {"title": "Small Molecule Registry", "description": "Molecules with a low molecular weight (generally < 900 daltons) used to perturb the experimental system, often binding to specific biological targets.","json_schema_extra": {"version": "0.0.34"}}
